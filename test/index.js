...
console.log(oa([{a:{a1:1,b1:2},b:2},{a:{a1:3,a2:4,a3:5}},{c:{c:10}}]))
...
describe('[{a:1,b:2,c:3},{a:4,b:5,d:6}]', ()=> {
    it('should return true', ()=> {
      assert.ok(oa([{a:1,b:2,c:3},{a:4,b:5,d:6}]).equals({a:5,b:7,c:3,d:6}));
    });
});

describe('[{a:{a1:1,b1:2},b:2},{a:{a1:3,a2:4,a3:5}},c:{c:10}}]', ()=> {
    it('should return true', ()=> {
      assert.ok(oa([{a:{a1:1,b1:2},b:2},{a:{a1:3,a2:4,a3:5}},{c:{c:10}}]).equals({ a: { a1: 4, b1: 2, a2: 4, a3: 5 }, b: 2, c: { c: 10 } }));
    });
});

describe("[{a:1,b:'bbb'},{a:'aaa',b:2,c:'ccc'}]", ()=> {
    it('should return true', ()=> {
      assert.ok(oa([{a:1,b:'bbb'},{a:'aaa',b:2,c:'ccc'}]).equals({a:1,b:2,c:0}));
    });
});

describe("[{a:{a1:1,a2:2},b:2},{a:1,b:{b1:1}}]", ()=> {
    it('should return true', ()=> {
      assert.ok(oa([{a:{a1:1,a2:2},b:2},{a:1,b:{b1:1}}]).equals({a:{a1:1,a2:2},b:2}));
    });
});
